...
import { XemThanhToanComponent } from '../../../Admin/thanh-toan/xem-thanh-toan/xem-thanh-toan.component';
...
export class LichsudattourkhachhangComponent implements OnInit {
  ...
  viewDetail(idDatTour: string): void {
    ...
    this.datTourServices.getThanhToanByIdDatTour(idDatTour).subscribe(
        (data: any) => {
            console.log(data);
            this.OpenPopup(data.idThanhToan,'Xem thanh toán')
        },
        (error) => {
